...
<html lang="es">
    ...
    <body>
    <p>
    9.- Busca información sobre las distintas funciones de las que se 
    dispone en php para realizar operaciones.
    </p>
    
    <a href="http://php.net/manual/es/ref.math.php" target="_blank">Doc oficial sobre funciones PHP para operar matemáticamente</a>
